...
WITH inflow_collections AS (
    ...
    SELECT 
        ...
        SUM(cf.net_flow_eth) AS dumb_whale_net_flow_eth,
        SUM(cf.net_flow_eth) * 2500.00 AS dumb_whale_net_flow_usd, -- 示例USD汇率
        SUM(cf.accu_net_flow_7d) AS dumb_whale_net_flow_7d_eth,
        SUM(cf.accu_net_flow_30d) AS dumb_whale_net_flow_30d_eth,
        CASE 
...
SELECT 
    ...
    dumb_whale_net_flow_eth,
    dumb_whale_net_flow_usd,
    dumb_whale_net_flow_7d_eth,
    dumb_whale_net_flow_30d_eth,
    CAST(dumb_whale_buyers AS INT) AS dumb_whale_buyers,
    CAST(dumb_whale_sellers AS INT) AS dumb_whale_sellers,
    dumb_whale_buy_volume_eth,
    dumb_whale_sell_volume_eth,
    dumb_whale_trading_percentage,
    floor_price_eth,
