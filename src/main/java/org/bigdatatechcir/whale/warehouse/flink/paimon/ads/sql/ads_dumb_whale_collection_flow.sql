...
-- 创建愚蠢鲸鱼净流入/流出Top10表
CREATE TABLE IF NOT EXISTS ads_dumb_whale_collection_flow (
    snapshot_date DATE,
    ...
    rank_num INT,
    dumb_whale_net_flow_eth DECIMAL(30,10),
    dumb_whale_net_flow_usd DECIMAL(30,10),
    dumb_whale_net_flow_7d_eth DECIMAL(30,10),
    dumb_whale_net_flow_30d_eth DECIMAL(30,10),
    dumb_whale_buyers INT,
    dumb_whale_sellers INT,
    dumb_whale_buy_volume_eth DECIMAL(30,10),
    dumb_whale_sell_volume_eth DECIMAL(30,10),
    dumb_whale_trading_percentage DECIMAL(10,2),
...
-- 计算并更新愚蠢鲸鱼净流入/流出Top10
INSERT INTO ads_dumb_whale_collection_flow
...
base_collection_stats AS (
    ...
    SELECT 
        ...
        SUM(cf.unique_whale_buyers) AS dumb_whale_buyers,
        SUM(cf.unique_whale_sellers) AS dumb_whale_sellers,
        SUM(cf.whale_buy_volume_eth) AS dumb_whale_buy_volume_eth,
        SUM(cf.whale_sell_volume_eth) AS dumb_whale_sell_volume_eth,
        CASE 
        ...
        END AS dumb_whale_trading_percentage
    FROM 
...
daily_inflow_collections AS (
    SELECT 
        ...
        bcs.daily_net_flow_eth AS dumb_whale_net_flow_eth,
        bcs.daily_net_flow_eth * 2500.00 AS dumb_whale_net_flow_usd,
        bcs.net_flow_7d_eth AS dumb_whale_net_flow_7d_eth,
        bcs.net_flow_30d_eth AS dumb_whale_net_flow_30d_eth,
        bcs.floor_price_eth,
        bcs.floor_price_change_1d,
        bcs.dumb_whale_buyers,
        bcs.dumb_whale_sellers,
        bcs.dumb_whale_buy_volume_eth,
        bcs.dumb_whale_sell_volume_eth,
        bcs.dumb_whale_trading_percentage,
        CASE 
...
weekly_inflow_collections AS (
    SELECT 
        ...
        bcs.net_flow_7d_eth AS dumb_whale_net_flow_eth,
        bcs.net_flow_7d_eth * 2500.00 AS dumb_whale_net_flow_usd,
        bcs.net_flow_7d_eth AS dumb_whale_net_flow_7d_eth,
        bcs.net_flow_30d_eth AS dumb_whale_net_flow_30d_eth,
        bcs.floor_price_eth,
        bcs.floor_price_change_1d,
...
monthly_inflow_collections AS (
    SELECT 
        ...
        bcs.net_flow_30d_eth AS dumb_whale_net_flow_eth,
        bcs.net_flow_30d_eth * 2500.00 AS dumb_whale_net_flow_usd,
        bcs.net_flow_7d_eth AS dumb_whale_net_flow_7d_eth,
        bcs.net_flow_30d_eth AS dumb_whale_net_flow_30d_eth,
        bcs.floor_price_eth,
        bcs.floor_price_change_1d,
...
SELECT 
    ...
    ac.dumb_whale_net_flow_eth,
    ac.dumb_whale_net_flow_usd,
    ac.dumb_whale_net_flow_7d_eth,
    ac.dumb_whale_net_flow_30d_eth,
    CAST(ac.dumb_whale_buyers AS INT) AS dumb_whale_buyers,
    CAST(ac.dumb_whale_sellers AS INT) AS dumb_whale_sellers,
    ac.dumb_whale_buy_volume_eth,
    ac.dumb_whale_sell_volume_eth,
    ac.dumb_whale_trading_percentage,
    ac.floor_price_eth,
